 ...
 * 		  데이터형
 * 		  문자열 여러개
 * 		 String[] arr=new double[5]  ==> double => 0.0
...
public class 자바배열 {
	...
	public static void main(String[] args) {
		...
		year=scan.nextInt(); // 키보드로 입력된 정수값을 읽어오는 역할
		...
		/*
		 * 	요일 구하기 
		 * 	1) 전년도까지 총날수 / 1년도 1월 1일 ~ 2019년 12월 31일까지로 계산
		 * 	2) 전달까지의 총날수 ==> 2020년 1월 1일 => 2020년 6월 30일계산
		 *  3) 입력된  day까지 총날수 구한다
		 * 	======================
		 *  => 전체총날수 % 7 ==> 요일을 구할 수 있다
		 *     ===========
		 ...
		 */
		 ...
		 /* 너무 길어서 이렇게 코딩 X => ↑ 위에처럼 코딩해야함 , 배열을 이용해라
		 switch (week) {
		 case 1:
		...
		// 윤년 계산하는 방법 외우라는게 아니라 이럴 때 배열쓰라는 거 기억하기 ★★	
	}
}
