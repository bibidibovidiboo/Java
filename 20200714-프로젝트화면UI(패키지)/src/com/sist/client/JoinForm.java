 ...
 *  
 *  ==> 상속
 *  	모든 클래스는 Object 상속을 가지고있다 => 모든 클래스를 받을 수 있다
 */
public class JoinForm extends JPanel {
	...
	public JoinForm() {
		...
		// 회원 가입 내용
		la1=new JLabel("아이디",JLabel.RIGHT); // 오른쪽정렬
		...
		title.setFont(new Font("맑은 고딕",Font.BOLD,45)); // <h1><b>회원가입</b></h1>
		...
		tf4.setBounds(525, 275, 100, 30); // 위에 500 + 20 더하고 약간 띄어서 밑에 525줌
