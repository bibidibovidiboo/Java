 ...
 *           = 모든 데이터형을 문자열로 변환 => valueOf() ex.valueOf(2) => "2"
 *           = 공백 문자 제거 : trim() => 좌우만 제거
 *           	"Hello Java" => "Hello Java"
 *           = 문자열 => char[] => toCharArray[]
 * 			 = startsWith , endsWith => 검색기 만들 때 많이씀
 * 
 *           ==========================================
 *           Wrapper Class
 *         	 =============
 ...
 * 	//  자르는 구간에 따라 달라서 2개를 씀
 *  substring(int start) 여기서부터 잘라라
 *  substring(int start,int end) 구역을 지정  
 */
public class 문자열2 {
	...
	public static void main(String[] args) {
		...
		// System.out.println(msg.substring(5)); // msg를 5번부터 잘라라
		// System.out.println(msg.substring(3)); // msg를 3번부터 잘라라
		// System.out.println(msg.substring(3,6)); 
		// ㄴ 345 출력 , 마지막꺼 출력 X => 내가 지정한 앞번까지 출력 ★
		
		String msg="100-010";
		//          0123456
		System.out.println(msg.substring(0,3)); // 100
		System.out.println(msg.substring(4,7)); // 010
		System.out.println(msg.substring(4)); // ㄴ 이렇게 해도됨 010
	}
}
