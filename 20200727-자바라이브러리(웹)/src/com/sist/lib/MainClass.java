...
import java.util.Date; // 변환 (시간,날짜) => SimpleDateformat()
//  알아야 할 부분 : 년도 대소문자로 표시하는 방법  / 날짜설정하는 법  ★★ 
//	< 표시법  >
//  yyyy 년도 => yy , 월 => M(MM) ,  일 => dd(d) , 시간 (h)hh , 분(mm) ,  초(s) => p.544
// 				    ==========				   =========
//				 	 h(1~12) , 				   H(0~23) 
//	< 캘린더  > 
//	1) 입력날짜 설정
...
public class MainClass {
	 ...
	 public static void main(String[] args) {
		...
		//변환  => 544page
		// 변환
		SimpleDateFormat sdf=new SimpleDateFormat("yyy-MM-dd hh:mm:ss"); // 기억 ★★
