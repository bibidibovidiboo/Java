 ...
 *		= 다형성
 *		  = 오버로딩 : 새로운 기능 추가 (new)
 *		  = 오버라이딩 : 기존에 있던 기능을 수정 (modify)
 *  
 *   ----------------------------------
 *   장점 : 유지보수가 용이하게 만드는 기법 
 *   단점 : 실행 속도가 늦다 (객체지향)
 *   ↓ 이를 보안하며 나온 것 
 *   ===================> POJO (Spring)
 *   
 ...
 *   	예) public int age;
 *   2) protected : 상속을 받는 경우에 하위클래스에서 사용이 가능
 *   	 / 상속에서 예외 조건
 ...
 *   ================================================================
 *   
 *   1. 데이터보호 : 값이 프로그램과 관련없이 변질 , 값 변경될 수 있다
 *   			 => 캡슐화 	
 *   				1) 데이터 보호하는 목적
 *   				      데이터를 은닉화 => 필요할 때만 메소드를 이용해서 사용
 */
public class 캡슐화 {
